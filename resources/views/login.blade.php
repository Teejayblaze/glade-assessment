<html class="loaded" lang="en" data-textdirection="ltr"><!-- BEGIN: Head--><head>
    ...
    <title>Glade Assessment &bull; {{$title}}</title>
    <link rel="apple-touch-icon" href="{{asset('theme-assets/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('theme-assets/images/ico/favicon.png')}}">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="{{url('login')}}" method="POST">
                            ...
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="email" class="form-control round" id="email" name="email" placeholder="Your Email" required autocomplete="off">
                                <div class="form-control-position">
                                    <i class="ft-user"></i>
                                </div>
                            </fieldset>
                            <fieldset class="form-group position-relative has-icon-left">
                                <input type="password" class="form-control round" id="password" name="password" placeholder="Enter Password" autocomplete="off" required>
                                <div class="form-control-position">
                                    <i class="ft-lock"></i>
                                </div>
                            </fieldset>
